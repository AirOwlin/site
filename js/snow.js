...
(function($) {
    ...
    $.fn.jSnow = function(h) {
        ...
        if ($.browser && $.browser.msie && (parseFloat($.browser.version) < 8)) useGif = true;
        if ($.browser && $.browser.msie && (parseFloat($.browser.version) < 8) && t == "auto") t = 0;
    ...
    // Инициализация снега при загрузке документа
    $(document).ready(function() {
        $("body").jSnow({
            ...
            fallingSpeedMin: 0.5, // Минимальная скорость снежинки
            fallingSpeedMax: 1, // Максимальная скорость снежинки
